...
import com.template.Student;
import com.template.service.StudentService;
import com.template.logger;
...
public class ReportsController {
    ...
    private void handleLoadReport() {
        ...
        logger.log("At-risk report generated with GPA threshold:" + threshold);
    }
    ...
    private void handleImportCSV() {
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader(file))) {
            ...
            logger.log(importedCount + "Students imported from CSV");
            logger.log(skippedCount + "duplicate students skipped during CSV import");
            alert.showAndWait();
